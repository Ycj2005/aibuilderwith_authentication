    ...
    <section className="relative pt-40 pb-24">
      ...
      <div className="w-full max-w-7xl mx-auto px-6 md:px-8">
        ...
        <div className="flex items-center justify-center flex-col sm:flex-row max-sm:gap-5 sm:justify-between mb-5">
          <div className="block">
            <h3 className="font-manrope font-bold text-4xl text-gray-400 mb-1 max-sm:text-center">
              {name}
            </h3>
          ...
          <Link
            href={"/dashboard"}
            className="py-3.5 cursor-pointer px-5 flex rounded-full bg-indigo-600 items-center shadow-sm shadow-transparent transition-all duration-500 hover:bg-indigo-700"
          >
            <svg
              width="20"
              height="20"
